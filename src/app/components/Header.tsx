...
const links =["Blogs","About","Skills"]
export default function Header() {
    return (
        
    <nav className="bg-gray-900 flex justify-between items-center h-20 p-4">
        ...
        <ul className="flex  gap-6 list-none font-semibold">
            ...
            <li key={link}>
                <Link href={"/"+ link.toLowerCase()}
                 className="p-2 hover:bg-orange-700 hover:rounded-2xl active:bg-red-700 focus:ring focus rounded-md focus:outline-dashed focus:ring-green-300">
                    { link }
            </Link>
             </li>))}
        </ul>
